...
get '/food' do
  ...
  hair = params[:user_hair]
  eye = params[:user_eye]
  erb :get_food, :locals => {:name => name, :age => age, :hair => hair, :eye => eye}
end
...
get '/drink' do
  ...
  eye = params[:user_eye]
  food = params[:user_food]
  erb :get_drink, :locals => {:name => name, :age => age, :hair => hair, :food => food, :eye => eye}
end
...
get '/three_numbers' do
  ...
  food = params[:user_food]
  drink = params[:user_drink]
  erb :three_numbers, :locals => {:name => name, :age => age, :hair => hair, :eye => eye, :food => food, :drink => drink}
end
...
get '/total' do
  ...
  erb :total, :locals => {:name => name, :age => age, :hair => hair, :eye => eye, :food => food, :drink => drink, :favnum1 => favnum1, :favnum2 => favnum2, :favnum3 => favnum3, :sum => sum}
end
